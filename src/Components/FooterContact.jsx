    ...
    <>
      <div className="bg-transparent  relative ">
        <form
          ...
          className="  m:mt-[-6rem] mt-[-10rem] box-shad rounded-3xl bg-whiteC mx-4 px-8 z-40 py-8 iix:px-4 ixr:px-6 s:mx-8 m:grid m:grid-cols-2 items-center m:py-2 m:gap-8  l:mx-20 sl:mx-36"
        >
          <div className="m:mt-0">
            <h3 className="tsgf  font-semibold iix:text-[20px] text-center ixr:text-[25px] s:text-[35px] s:leading-normal leading-8  m:text-left m:mt-0 l:text-72 sl:text-[45px]">
              Let's Get Started with Your
              <span className=" shadow-inner border-b-2 text-brightC p-1 iix:p-2   ">
                Website
              </span>{" "}
            </h3>
            <p className="tsgf text-center text-greyC pt-1 m:text-left">
          ...
          <div className="flex flex-col gap-4 items-center text-center justify-center m:flex m:flex-row m:px-4 m:items-center m:py-4 m:justify-between l:px-12 sl:px-36">
            <div className="iix:py-4 ixr:py-6 rounded-2xl text-center  m:py-0 m:flex-1">
              <p className="tsgf mb-4 m:p-2 p-4 m:mb-1 ">
                Boost your business with our premier web design services. Embark
                on a journey of excellence! Reach out for a customized
